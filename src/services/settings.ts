...
export type MenuSettings={company:string;menuTitle:string;logo?:string;banner?:string;licenseStart:string;licenseEnd:string;licenseDaysRemaining:number;slug:string}
...
export const saveSettings=(data:{company:string;menuTitle:string;logo?:string;banner?:string})=>api('/settings',{method:'PUT',body:JSON.stringify(data)}) as Promise<MenuSettings>
